...
寒い夜、布団にくるまって映画を観るのが好きなんです。  
でも、クラムシェルモードで運用しているPCは、キーボードやマウスがないと操作できない。  
布団の中からわざわざ手を出すのは億劫だし、キーボードは重くて邪魔。

スマホで操作できたらいいなと思って、Remote Mouseを使おうとしたけれど、  
脆弱性報告への対応がなく、常に外部にパケットを送っているというコメントもあって不安に。  

それなら、自分で安心して使えるものを作ってしまおうと思って作ったのがこのアプリです。
